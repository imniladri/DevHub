...
let androidData = [
	...
	},
	{
		id: 16,
		lib_name: "EventBus",
		lib_details: "An open-source library for Android and Java using the publisher/subscriber pattern for loose coupling",
		lib_color: "#FF6B6B",
	...
	},
	{
		...
		lib_details: "Renowned view binding android support library helping in assigning ids to views very effortlessly",
		lib_color: "#FF6B6B",
	...
	},
	{
		...
		lib_details: "Android chart/graph view library with radar, line, bar, bubble, pie, candlestick charts along with scaling, animations, and dragging",
		lib_color: "#FF6B6B",
		lib_link: "https://play.google.com/store/apps/details?id=com.xxmassdeveloper.mpchartexample&hl=en_IN&gl=US",
	},
	{
		id: 19,
		lib_name: "MyLittleCanvas",
		lib_details: "Android Library used to achieve features such as custom underline on a TextView, Textshape, lineshape, etc.",
		lib_color: "#FF6B6B",
	...
	},
	{
		id: 23,
		lib_name: "Timber",
		lib_details: "A logger with a small, extensible API which provides utility on top of Android's normal Log class.",
		lib_color: "#FF6B6B",
	...
	},
	{
		...
		lib_details: "Android KTX is a set of Kotlin extensions that wraps Android API, making it more user-friendly",
		lib_color: "#FF6B6B",
