...
let apiData = [
	...
	},
	{
		...
		lib_details:
			"Restful API for Football data with competitions, Livescore, teams, statistics, predictions etc.",
	...
	},
	{
		...
		lib_details:
			"API for seamless SMS, Chat, Voice functionalities for websites and applications",
	...
	},
	{
		...
		lib_details:
			"News API that provides a real-time coverage feed to directly use the news data",
	...
	},
	{
		...
		lib_name: "SendGrid",
		lib_details:
			"Cloud-based Web API that allows to send email without having to maintain email servers",
	...
	},
	{
		...
		lib_details:
			"The WordPress REST API provides the posts, pages, taxonomies, and other built-in WordPress data types",
		lib_link: "https://sendgrid.com/",
	},
	{
		id: 7,
		...
		lib_details:
			"The Domainr API lets you retrieve instant domain search results and availability status",
	...
	},
	{
		...
		lib_name: "WordsAPI",
		lib_details:
			"Retrieve information about English words, including definitions, synonyms, rhymes, pronunciation etc",
	...
	},
	{
		...
		lib_details:
			"Provides user-friendly music metadata and playlists for using in web and applications",
	...
	},
	{
		...
		lib_details:
			"Helps developers to take the power of Google Maps and put it directly on web and applications",
	...
	},
	{
		...
		lib_name: "Giphy API",
		lib_details:
			"GIPHY API helps you integrate the world's largest GIF library, boost engagement with just a few lines of code",
	...
	},
	{
		...
		lib_name: "Bitly API",
		lib_details:
			"By this API, you will exercise the full power of your links through automated link customization, click analytics",
	...
	},
	{
		...
		lib_details:
			"Privacy-safe Identity Resolution company building trust between people and brands",
	...
	},
	{
		...
		lib_details:
			"Twitter API enables to tap into core elements of twitter like: Tweets, direct messages, spaces, users etc,",
	...
	},
	{
		...
		lib_details:
			"HTTP-based API that allows developers to extract data and functionality from the Facebook platform",
	...
	},
	{
		...
		lib_details:
			"An HTTP/S REST API where all operations are via HTTP PUT, POST, GET, DELETE, and HEAD requests",
	...
	},
	{
		...
		lib_name: "Dropbox",
		lib_details:
			"Allows developers to work with files in Dropbox, including advanced functionality like full-text search, thumbnails, and sharing",
